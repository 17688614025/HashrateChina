...
export default {
  ...
  series: [
    ...
    },
    {
      ...
      smooth: true,
      data: []
      // data: [901, 934, 1290, 1330, 820, 932, 901, 934, 1290, 1330, 1320, 932, 1320, 1290, 1330, 1320]
    },
    {
      name: '挖矿锁仓',
      type: 'line',
      smooth: true,
      data: []
      // data: [1290, 1330, 1320, 1290, 1330, 820, 932, 901, 934, 1290, 1330, 1320, 932, 901, 934, 1320]
    }
  ]
}
