...
(function(global, factory) {
  ...
  var boundsStream = {
    ...
    polygonEnd: function() {
      ...
      if (areaRingSum < 0) { (lambda0$1 = -(lambda1 = 180)), (phi0 = -(phi1 = 90)) } else if (deltaSum > epsilon) phi1 = 90
  ...
  function rotationIdentity(lambda, phi) {
    return [
      lambda > pi ? lambda - tau : lambda < -pi ? lambda + tau : lambda,
      phi
    ]
  }
  ...
  var circle = function() {
    ...
    circle.center = function(_) {
      return arguments.length
        ? ((center = typeof _ === 'function' ? _ : constant([+_[0], +_[1]])),
        circle)
        : center
    }
    ...
    circle.radius = function(_) {
      return arguments.length
        ? ((radius = typeof _ === 'function' ? _ : constant(+_)), circle)
        : radius
    }

    circle.precision = function(_) {
      return arguments.length
        ? ((precision = typeof _ === 'function' ? _ : constant(+_)), circle)
        : precision
    }
